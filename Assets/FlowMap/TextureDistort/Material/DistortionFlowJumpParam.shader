Shader "Custom/DistortionFlowJumpParam" {
	Properties {
	...
	SubShader {
		...
		void surf (Input IN, inout SurfaceOutputStandard o) {
			...
			float3 uvwA = FlowUVW(IN.uv_MainTex, flowVector, jump, time, 0);
			float3 uvwB = FlowUVW(IN.uv_MainTex, flowVector, jump, time, 0.5);
